...
augroup myfiletypes
	...
	autocmd FileType ruby,eruby,yaml, set ai ts=2 sw=2 sts=2 et omnifunc=rubycomplete#Complete
...
let g:rubytest_cmd_spec = "screen -S foo -p test -X stuff 'spec --drb -c -f n %p'"
let g:rubytest_cmd_example = "screen -S foo -p test -X stuff \"spec --drb -c -f n %p -e '%c'\""
